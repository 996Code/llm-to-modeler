...
function widgetHtml(w: any): string {
  // 刷新图标与工具条 ReloadOutlined 完全同形:同一个 path(antd 官方
  // reload svg 原文)+ 同 viewBox 64 64 896 896——两处刷新一个模样
  return `
